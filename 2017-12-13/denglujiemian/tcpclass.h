...
{
public:
    QString FriendCount;        //朋友账号  或者  名字  在修改名字的操作过程中此操作为用户的Name
    QString Remark;             //备注
    QString Age;            //年龄
    QString NickName;           //昵称
    QString Sex;
...
public:
    ...
    void receiveTcpMessage(QString &Judge,QTcpSocket *tcpSocket_1);
    void SendMyMessage(Friend message,QTcpSocket *tcpSocket_1);                 //发送我的嘻嘻你
private:
    int sWidth;
    int sHeight;
