...
signals:
    ...
    void ShowPicture();
    void ChangeSettingPage(int,Friend);                    //设置改变的是哪个界面
    void SendChatViewSocket();                          //送聊天界面套接字
    void loginWidgetShow();                         //显示登录界面

private:
    ProductWindows FarmProductPage;
private:
    Friend MyMessage;               //我的信息
...
private slots:
    ...
    void ChangeMymessage(Friend);           //改变信息
    /*****************************网络*****************************/
    /*****************************网络*****************************/
    /*****************************网络*****************************/
private:
    bool is_click_Backbt;
    ...
    QTcpSocket *tcpSocket_receiveMyMessage;         //接收我的账号信息
