...
void ProductWindows::receiveMessage()
{
    ...
    {
        Friend newFriend;
        ReceiveFriendTcpMessage FriendReceive(ReceiveSeller);

        FriendReceive.ReceiveOneFriendMessage(newFriend);
    ...
    else if(sender()==PayGoodsMoney)
    {
        ...
        if(Judge=="购买成功")
        {
            ...
            ui->labelshow->setText("恭喜您商品以购买成功！\n商品编号为:"+PaySuccessfullyCommodityCode);
